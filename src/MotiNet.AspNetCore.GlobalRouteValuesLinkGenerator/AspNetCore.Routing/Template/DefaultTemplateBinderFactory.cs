...
{
    internal sealed class DefaultTemplateBinderFactory : GlobalRouteValuesLinkGeneratorTemplateBinderFactory
    {
        ...
        public override GlobalRouteValuesLinkGeneratorTemplateBinder Create(RouteTemplate template, RouteValueDictionary defaults)
        {
            if (template == null)
            {
            ...
            return new GlobalRouteValuesLinkGeneratorTemplateBinder(UrlEncoder.Default, _pool, template, defaults);
        }

        public override GlobalRouteValuesLinkGeneratorTemplateBinder Create(RoutePattern pattern)
        {
            if (pattern == null)
            {
            ...
            return new GlobalRouteValuesLinkGeneratorTemplateBinder(UrlEncoder.Default, _pool, pattern, policies);
        }
    }
}
