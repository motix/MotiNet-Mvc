...
{
    public abstract class DefaultLinkGenerator : LinkGenerator, IDisposable
    {
        private readonly ParameterPolicyFactory _parameterPolicyFactory;
        private readonly GlobalRouteValuesLinkGeneratorTemplateBinderFactory _binderFactory;
        ...
        // Caches GlobalRouteValuesLinkGeneratorTemplateBinder instances
        private readonly DataSourceDependentCache<ConcurrentDictionary<RouteEndpoint, GlobalRouteValuesLinkGeneratorTemplateBinder>> _cache;

        // Used to initialize GlobalRouteValuesLinkGeneratorTemplateBinder instances
        private readonly Func<RouteEndpoint, GlobalRouteValuesLinkGeneratorTemplateBinder> _createTemplateBinder;
